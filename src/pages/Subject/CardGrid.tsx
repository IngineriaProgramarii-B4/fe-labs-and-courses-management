...
const CardGrid: React.FC<CardGridProps> = (props) => {
  ...
  const handleAddCard = () => {
    const newCard = {
      ...
      title: `Materie ${props.cards.length + 1}`,
      image:
  ...
  const initializeSubjecEditProperties = (title: string) => {
    const currentSubject = props.cards.filter(
            ...
            {/* <Card
              ...
              actions={[
                ...
                <Button
                  type="text"
                  key="delete"
                  onClick={(event) => handleDeleteClick(event, card.title)}
                >
                  Delete
                </Button>,
              ]}
        ...
        <Form layout="vertical" name="add_subject">
          ...
          <Row>
            <Col span={12} style={{ paddingRight: "10px" }}>
              ...
              >
                <Select value={yearAdd} onChange={(event) => setYearAdd(event)}>
                  <Select.Option value="1">1</Select.Option>
                  <Select.Option value="2">2</Select.Option>
                  <Select.Option value="3">3</Select.Option>
                  <Select.Option value="4">4</Select.Option>
