...
describe('ResourcesTable', () => {
  ...
  test('rendering ResourceTable', async () => {
  ...
  test('throws an error when delete', async () => {
    const data = [
      {
        key: '1',
        title: 'Resource 1',
    ...
    const axiosDeleteMock = jest.spyOn(axios, "delete").mockRejectedValue(new Error("Mock error"));
