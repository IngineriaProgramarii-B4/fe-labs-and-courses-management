...
function SubjectAlex() {
  ...
  const initializeSubjecEditProperties = (title: string) => {
    const currentSubject = cards.filter(
      (card: Subject) => card.title === title
    );
          ...
          <div className="container cardgrid">
                  ...
                  <Card
                    ...
                    actions={[
                      ...
                      <Button
                        ...
                        key="delete"
                        onClick={(event) =>
                          handleDeleteClick(event, card.title)
                        }
                      >
                        Delete
                      </Button>,
            ...
            >
              ...
              >
                <Meta
                  title={
                    <div className="card-meta-title" style={{ fontSize: 13 }}>
                      Add a new subject
                    </div>
                  }
                />
            ...
            <Modal
              ...
              footer={[
                <Button key="cancel" onClick={() => setSubjectModal(false)}>
                  Cancel
                </Button>,
                <Button
                  key="submit"
                  type="default"
                  onClick={() => submitChangesToSubject(titleEdit)}
                >
                  Submit
                </Button>,
              ]}
            >
              <Form layout="vertical" name="edit_subject" form={form}>
                <Form.Item
                  label="Title"
                  name="title"
                  rules={[
                  ...
                  rules={[
                    {
                      required: true,
                      message:
                        "Please select the number of credits of the subject!",
                    },
                  ]}
                >
                  <Select
            ...
            >
              <Form layout="vertical" name="add_subject">
                <Form.Item
                  label="Title"
                  name="title"
                  rules={[
